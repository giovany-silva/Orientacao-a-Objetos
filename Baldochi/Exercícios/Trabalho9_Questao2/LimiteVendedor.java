...
public class LimiteVendedor {
    ...
    private void cadastraComissionado() {
        ...
        String comis = JOptionPane.showInputDialog("Informe a comissão");
    ...
    private void cadastraContratado() {
        ...
        int codigo = Integer.parseInt(cod);
        String nome = JOptionPane.showInputDialog("Informe o nome");
        String sal = JOptionPane.showInputDialog("Informe o salário fixo");
        double salarioFixo = Float.parseFloat(sal);
        String nroCartTrabalho = JOptionPane.showInputDialog("Informe o número da carteira de trabalho");
        objCtrVendedor.insereContratado(codigo, nome, salarioFixo, nroCartTrabalho);
    }

    private void cadastraVendas() {
        String Cod = JOptionPane.showInputDialog("Informe o código do vendedor");
        int codigo = Integer.parseInt(Cod);
        String cod = JOptionPane.showInputDialog("Informe o código do imóvel");
        ...
        String val = JOptionPane.showInputDialog("Informe o valor");
